          ...
          >
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-6 py-6 border-b border-white/5">
              <div className="flex items-center gap-4">
                <button 
                  onClick={resetTrace} 
                  className="flex items-center gap-3 px-5 py-2.5 rounded-xl bg-white/5 hover:bg-white/10 text-white/60 hover:text-white transition-all group"
                >
                  <ArrowLeft size={16} className="group-hover:-translate-x-1 transition-transform" />
                  <span className="text-[10px] font-bold uppercase tracking-widest">Back to Source Finder</span>
                </button>
                <div>
