...
import Hero from './Trusty-web-master-main/components/Hero.tsx';
import TrustStrip from './Trusty-web-master-main/components/TrustStrip.tsx';
import UploadZone from './Trusty-web-master-main/components/UploadZone.tsx';
import HowItWorks from './Trusty-web-master-main/components/HowItWorks.tsx';
import AnalysisDeepDive from './Trusty-web-master-main/components/AnalysisDeepDive.tsx';
import ResultsPreview from './Trusty-web-master-main/components/ResultsPreview.tsx';
import ProcessingScreen from './Trusty-web-master-main/components/ProcessingScreen.tsx';
import ResultsScreen from './Trusty-web-master-main/components/ResultsScreen.tsx';
import LiveScanner from './Trusty-web-master-main/components/LiveScanner.tsx';
import SignalLibrary from './Trusty-web-master-main/components/SignalLibrary.tsx';
import BackgroundGraphics from './Trusty-web-master-main/components/BackgroundGraphics.tsx';
import HistoryPanel from './Trusty-web-master-main/components/HistoryPanel.tsx';
import TextInterrogator from './Trusty-web-master-main/components/TextInterrogator.tsx';
import ReverseGrounding from './Trusty-web-master-main/components/ReverseGrounding.tsx';
import JudicialReport from './Trusty-web-master-main/components/JudicialReport.tsx';
import BatchTriage from './Trusty-web-master-main/components/BatchTriage.tsx';
import Sidebar from './Trusty-web-master-main/components/Sidebar.tsx';
import Logo from './Trusty-web-master-main/components/Logo.tsx';
import FloatingAssistant from './Trusty-web-master-main/components/FloatingAssistant.tsx';
...
const App: React.FC = () => {
  ...
  useEffect(() => {
    const saved = localStorage.getItem('trusty_history');
    if (saved) {
  ...
  const saveToHistory = (result: AnalysisResult) => {
    ...
    localStorage.setItem('trusty_history', JSON.stringify(newHistory));
  };
